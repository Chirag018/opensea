...
function Resource() {
    return (
        <div class="grid pb-36 grid-rows-2">
            <div class="head-para grid grid-rows-2 justify-center mb-10">
            ...
            <div class="carasoel flex items-center justify-center gap-x-10">
               <RiArrowLeftSLine/>
                <div class="border flex bg-green-200 w-56 p-1 items-center">
